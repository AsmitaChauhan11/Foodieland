...
import { faScroll, faClock, faUtensils } from  "@fortawesome/free-solid-svg-icons";
...
export default function HeroSection(){
    ...
    return(
        ...
        <div className="frame-section">
            <div className="col1">
                <button style={{ width: 'auto', maxWidth: 'fit-content', whiteSpace: 'nowrap' }} className="hot-recipe">
                ...
                <div className="tags">
                    <span className="tag">
                        <FontAwesomeIcon icon={faClock} style={{ fontSize: '18px',marginRight: '5px' }} />
                        30 Minutes
                    </span>
                    <span className="tag">
                        <FontAwesomeIcon icon={faUtensils} style={{ fontSize: '18px',marginRight: '5px' }} />
                        Chicken
                    </span>
                </div>
                <p className="description">
                    These spicy, delicious chicken wings are perfectly seasoned and cooked to crispy perfection, then paired with a tangy dipping sauce for an irresistible flavor. Enjoy this easy-to-make recipe that brings bold taste and satisfaction with every bite.
                </p>
                ...
                <button className="view-recipes" onClick={() => window.location.href = '/Recipes'}>View Recipes</button>
            </div>
            <div className="col2">
