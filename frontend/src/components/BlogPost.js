...
const articles = [
    ...
    { 
        ...
        author: 'Robert Fox', 
        description: 'Looking for fresh, flavorful vegetarian dishes to try? This blog features ten seasonal recipes packed with vibrant vegetables and wholesome ingredients. From hearty salads to satisfying mains, these recipes are perfect for anyone wanting to eat healthily and enjoy meat-free meals. Whether you\'re a lifelong vegetarian or simply looking to add more plant-based meals to your diet, these recipes are both delicious and nourishing.',
        date: '01 June 2023', 
    ...
    { 
        ...
        description: 'Discover a flavorful fusion of plantains and pinto beans in this hearty stew, complemented by the zesty kick of Aji Verde sauce. This blog guides you through creating this warming dish, ideal for chilly days and perfect for those who love a bit of South American flair in their cooking. With its vibrant flavors and comforting ingredients, this stew is a unique, crowd-pleasing dish that brings warmth and excitement to your table.',
        date: '09 April 2024', 
...
export default function BlogPost() {
    ...
    const handleArticleClick = (article) => {
        if (article.id === 5) { // Only open detailed view for article with ID 5
    ...
    if (selectedArticle) {
        return <BlogPostArticle article={selectedArticle} onBack={handleBackToArticles} />;
    }
                        ...
                        {articles.map((article) => (
                            <div key={article.id} className="article-card">
                                ...
                                <div className="blog-content">
                                    <h3 className="blog-title" onClick={() => handleArticleClick(article)}>
                                        {article.title}
                                    </h3>
